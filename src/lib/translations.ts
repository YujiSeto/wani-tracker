...
const translations = {
  en: {
    ...
    'dash.vacation.active': '🏖️ Active',
    'dash.vacation.inactive': 'Inactive',
    'dash.lessons': 'Available Lessons',
    'dash.reviews': 'Pending Reviews',
    'dash.stats': 'Study Stats',
  ...
  pt: {
    ...
    'dash.vacation': 'Férias',
    'dash.vacation.active': '🏖️ Ativas',
    'dash.vacation.inactive': 'Inativas',
  ...
  ja: {
    ...
    'dash.vacation': '休暇',
    'dash.vacation.active': '🏖️ アクティブ',
    'dash.vacation.inactive': '非アクティブ',
